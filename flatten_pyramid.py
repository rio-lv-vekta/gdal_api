...
input_tiles_dir = "/app/outputs_2"  # Directory where gdal2tiles.py outputs the tiles
consolidated_tiles_dir = "/app/test_outputs_2"  # Directory for the consolidated tiles
